...
if (autobio === false) return           
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await alpha.setStatus(`${setting.botname} | Runtime ${uptimer} | ${status} By Leviathan corporation`).catch((_) => _);
...
case 'bcgif':
         ...
         case 'owner':
         case 'creator':  
         ini_ownerNumber = [`6282311619167@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					let ini_list = []
			...
			case 'sticker': case 'stikerin':
				case 'stiker': case 's':{
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							exif.create('Alya Bots', 'Radhin & Alya', `stickwm_${sender}`)
							//ran = getRandom('.webp')
                        await ffmpeg(`./${media}`)
                            .input(media)
                        ...
                        exif.create('Created By', 'Radhin', `stickwm_${sender}`)
                    //    ran = getRandom('.webp')
                        await ffmpeg(`./${media}`)
